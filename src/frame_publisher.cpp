...
int main(int argc, char **argv)
{
  ...
  skeleton_listener.waitForTransform("/openni/torso", "/openni/head", ros::Time::now(), ros::Duration(3.0));

  std::string user_no = argc == 1 ? "1" : argv[1];
  std::string left_hand = "/openni/left_hand", right_hand = "/openni/right_hand";
  std::string left_palm = "/openni/left_palm", right_palm = "/openni/right_palm";
